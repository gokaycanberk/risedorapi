...
public class GetOrdersBySupermarketQueryHandler
    : IRequestHandler<GetOrdersBySupermarketQuery, List<OrderDto>>
{
    private readonly ApplicationDbContext _context;

    public GetOrdersBySupermarketQueryHandler(ApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<List<OrderDto>> Handle(
        GetOrdersBySupermarketQuery request,
        CancellationToken cancellationToken
    )
    {
        var orders = await _context.Orders
            .Include(o => o.Items)
            .Where(o => o.SupermarketUserId == request.SupermarketId)
            .AsNoTracking()
