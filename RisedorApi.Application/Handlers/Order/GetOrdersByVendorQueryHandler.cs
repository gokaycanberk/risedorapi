...
public class GetOrdersByVendorQueryHandler : IRequestHandler<GetOrdersByVendorQuery, List<OrderDto>>
{
    private readonly ApplicationDbContext _context;

    public GetOrdersByVendorQueryHandler(ApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<List<OrderDto>> Handle(
        GetOrdersByVendorQuery request,
