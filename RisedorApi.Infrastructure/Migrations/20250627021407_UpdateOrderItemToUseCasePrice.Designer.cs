...
namespace RisedorApi.Infrastructure.Migrations
{
    ...
    [Migration("20250627021407_UpdateOrderItemToUseCasePrice")]
    partial class UpdateOrderItemToUseCasePrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RisedorApi.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("SalesRepUserId")
                        .HasColumnType("integer");

                    b.Property<int>("Status")
                        .HasColumnType("integer");

                    b.Property<int>("SupermarketUserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RisedorApi.Domain.Entities.Order", b =>
                {
                    b.HasOne("RisedorApi.Domain.Entities.User", "SalesRep")
                        .WithMany()
                    ...
                    b.HasOne("RisedorApi.Domain.Entities.User", "Supermarket")
                        .WithMany()
                        .HasForeignKey("SupermarketUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
